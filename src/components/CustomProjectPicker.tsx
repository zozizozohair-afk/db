  ...
  return (
    <div className={`relative w-full ${className}`}>
      ...
      <button
        ...
        `}
      >
        <span className={`font-medium text-lg ${selectedProject ? 'text-gray-900' : 'text-gray-400'}`}>
          {selectedProject ? `${selectedProject.project_number} - ${selectedProject.name}` : placeholder}
        </span>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-3xl border border-gray-200 shadow-2xl p-6 w-full max-w-lg animate-in fade-in zoom-in duration-200">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold text-gray-900">اختر المشروع</h3>
              </div>
